    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Pemeriksaan Perangkat Lunak') }}
            </h2>
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        <h1 class="text-2xl font-bold text-gray-800">Tambah Data Pemeriksaan Perangkat Lunak</h1>
                    ...
                    <form action="{{ route('periksa_lunak.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    fetch(`/get-lunak/${labId}`)
                        ...
                        .then(data => {
                            ...
                            for (let i = 0; i < jumlahMeja; i++) {
                                ...
                                row.innerHTML = `${noCell}${fungsiInputs}${ketCell}`;
                                isiTable.appendChild(row);
                            }
                        })
                        .catch(error => console.error("Error fetching perangkat lunak:", error));
                }
            });
        });
    </script>
