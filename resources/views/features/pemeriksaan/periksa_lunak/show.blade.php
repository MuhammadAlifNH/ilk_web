    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-800">Data Pemeriksaan Perangkat Lunak</h1>
                <a href="{{ route('periksa_lunak.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg flex items-center transition duration-150 ease-in-out">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="text-center mb-6">
                        <h2 class="text-2xl font-bold">Laporan Pemeriksaan Perangkat Lunak</h2>
                        <p class="text-lg font-semibold">
                            RUANG LABORATORIUM {{ $periksa_lunak->lab->nama_lab }},
                            {{ $periksa_lunak->fakultas->nama_fakultas }}
                        </p>
                        <p class="text-gray-600">Tanggal: {{ $periksa_lunak->tanggal }}</p>
                    </div>

                    <!-- Tabel Pemeriksaan -->
                    <div class="overflow-x-auto">
                        @php
                            $detailsByMeja = $periksa_lunak->details->groupBy('meja_ke');
                            $perangkatList = $periksa_lunak->details->pluck('perangkat.nama')->unique()->values();
                        @endphp
                    ...
                    <div class="my-4 flex justify-end space-x-2">
                        ...
                        <a href="{{ route('periksa_lunak.download', $periksa_lunak) }}" class="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-lg">
                            Download PDF
                        </a>
                    </div>
                </div>
