                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="overflow-x-auto rounded-lg border border-gray-200">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody id="perks-table-body" class="bg-white divide-y divide-gray-200">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="px-6 py-4 text-center text-gray-500">Tidak ada data perangkat keras</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
